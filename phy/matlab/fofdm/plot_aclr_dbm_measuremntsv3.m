...
plot(Pref_dBm(:,1),Pref_dBm(:,2),'b*')
plot(Pref_dBm(:,1),Pref_dBm(:,3),'ko')
plot(Pref_dBm(:,1),Pref_dBm(:,4),'rs')
hold off
grid on
...
legend('P_{ref} - No filter','P_{adj} - No filter','P_{ref} - 64 order FIR','P_{adj} - 64 order FIR','P_{ref} - 128 order FIR','P_{adj} - 128 order FIR','Location','northwest');
...
plot(Pref_dBm(:,1),Pref_dBm(:,2),'b*')
plot(Pref_dBm(:,1),Pref_dBm(:,3),'k*')
plot(Pref_dBm(:,1),Pref_dBm(:,4),'r*')
hold off
grid on
