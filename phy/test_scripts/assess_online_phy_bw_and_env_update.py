...
def rxParametersThread(lc, mcs_idx, num_of_rx_slots, seq_num, send_to, source_module, debug):
   while(getExitFlag() == False):
      ...
      sendRxCtrlToPhy(lc, bandwidth, rx_channel, mcs_idx, rx_gain, num_of_rx_slots, seq_num, send_to, phy_id, source_module, timestamp, debug)
      time.sleep(0.5)
...
if __name__ == '__main__':
    ...
    run_rx_params_thread = False
    run_tx_params_thread = False
