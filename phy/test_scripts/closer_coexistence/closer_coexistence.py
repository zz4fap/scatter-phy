                    ...
                    if(internal.transaction_index == 66):
                       if(internal.receiver.result == PHY_SUCCESS):
                           ...
                           if(saveStatsToFile == True):
                              ...
                              f.write("%d\t%d\t%d\t%1.4f\t%d\t%.10f\t%1.4f\t%d\t%d\t%d\t%d\t%d\n" % (result, channel, mcs_idx, rssi, cqi, noise, sinr, total_nof_detected, nof_detection_errors, nof_decoding_errors, total_nof_synchronized, nof_decoded_pkts))

                           if(nof_decoded_pkts%1000 == 0):
                              print("nof_decoded_pkts: %d" % (nof_decoded_pkts))
                       ...
                       if(internal.receiver.result == PHY_ERROR):
                           if(saveStatsToFile == True):
                              ...
                              f.write("%d\t%d\t%d\t%1.4f\t%d\t%.10f\t%1.4f\t%d\t%d\t%d\t%d\t%d\n" % (result, channel, 0, rssi, 0, noise, 0.0, total_nof_detected, nof_detection_errors, nof_decoding_errors, total_nof_synchronized, nof_decoded_pkts))
