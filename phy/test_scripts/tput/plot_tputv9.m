...
expected_tput_6prb = reshape(expected_tput(1,1,1:length(mcs_found)),1,17);
current_tput_6prb = reshape(current_tput(1,1,1:length(mcs_found)),1,17);

expected_tput_15prb = reshape(expected_tput(2,1,1:length(mcs_found)),1,17);
current_tput_15prb = reshape(current_tput(2,1,1:length(mcs_found)),1,17);

expected_tput_25prb = reshape(expected_tput(3,1,1:length(mcs_found)),1,17);
current_tput_25prb = reshape(current_tput(3,1,1:length(mcs_found)),1,17);

expected_tput_50prb = reshape(expected_tput(4,1,1:length(mcs_found)),1,17);
current_tput_50prb = reshape(current_tput(4,1,1:length(mcs_found)),1,17);
