...
//******************************************************************************
SRSLTE_API int srslte_softbuffer_tx_init_scatter(srslte_softbuffer_tx_t *q, uint32_t nof_prb);

SRSLTE_API void srslte_softbuffer_tx_free_scatter(srslte_softbuffer_tx_t *q);

SRSLTE_API int srslte_softbuffer_rx_init_scatter(srslte_softbuffer_rx_t *q, uint32_t nof_prb);

SRSLTE_API void srslte_softbuffer_rx_free_scatter(srslte_softbuffer_rx_t *q);
