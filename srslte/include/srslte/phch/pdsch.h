...
typedef struct SRSLTE_API {
  ...
  void *e;
   ...
   float *csi;             /* Channel Strengh Indicator */
...
SRSLTE_API int srslte_pdsch_cfg_scatter(srslte_pdsch_cfg_t *cfg, bool add_sch_to_front, uint32_t eob_pss_len, srslte_cell_t cell, srslte_ra_dl_grant_t *grant, uint32_t cfi, uint32_t sf_idx, uint32_t rvidx);

SRSLTE_API int srslte_pdsch_encode_seq_scatter(srslte_pdsch_t *q,
                                               srslte_pdsch_cfg_t *cfg,
                                               srslte_softbuffer_tx_t *softbuffer,
                                               uint8_t *data,
...
SRSLTE_API int srslte_pdsch_encode_scatter(srslte_pdsch_t *q,
                                           srslte_pdsch_cfg_t *cfg,
                                           srslte_softbuffer_tx_t *softbuffer,
                                           uint8_t *data,
                                           cf_t *sf_symbols[SRSLTE_MAX_PORTS]);

SRSLTE_API int srslte_pdsch_encode_rnti_scatter(srslte_pdsch_t *q,
                                                srslte_pdsch_cfg_t *cfg,
                                                srslte_softbuffer_tx_t *softbuffer,
                                                uint8_t *data,
                                                uint16_t rnti,
...
SRSLTE_API int srslte_pdsch_put_scatter(srslte_pdsch_t *q, cf_t *symbols, cf_t *sf_symbols, srslte_ra_dl_grant_t *grant, uint32_t subframe, bool add_sch_to_front);

SRSLTE_API int srslte_pdsch_cp_scatter(srslte_pdsch_t *q, cf_t *input, cf_t *output, srslte_ra_dl_grant_t *grant, uint32_t nsubframe, bool add_sch_to_front, bool put);

SRSLTE_API int srslte_pdsch_decode_rnti_scatter(srslte_pdsch_t *q,
...
SRSLTE_API int srslte_pdsch_get_scatter(srslte_pdsch_t *q, cf_t *sf_symbols, cf_t *symbols, srslte_ra_dl_grant_t *grant, uint32_t subframe, bool add_sch_to_front);
