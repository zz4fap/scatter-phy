...
UHD_API uhd_error uhd_usrp_set_fir_taps(
    uhd_usrp_handle h,
    size_t nof_prb,
    size_t chan
);
...
//! Set the given RX channel's sample rate (in Sps)
UHD_API uhd_error uhd_usrp_set_rf_mon_rate(
    uhd_usrp_handle h,
    double rate
);

//! Get the given RX channel's sample rate (in Sps)
UHD_API uhd_error uhd_usrp_get_rf_mon_rate(
    uhd_usrp_handle h,
    double *rate_out
);
...
//! Set DDC frequency to switch scatter channels
UHD_API uhd_error uhd_usrp_set_rx_channel_freq(
    uhd_usrp_handle h,
    size_t chan,
    double freq
...
//! Set DUC frequency to switch scatter channels
